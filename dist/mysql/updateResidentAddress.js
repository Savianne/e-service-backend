        ...
        return new Promise((resolve, reject) => {
            promisePool.getConnection()
                ...
                connection.beginTransaction()
                    ...
                    update.permanentAddress && (yield connection.query("UPDATE permanent_address SET region = ?, province = ?, city_mun = ?, barangay = ?, zone = ? WHERE permanent_address.id = ?", [update.permanentAddress.region, update.permanentAddress.province, update.permanentAddress.cityMun, update.permanentAddress.barangay, update.permanentAddress.zone, FKeys.permanentAddresID]));
                    connection.commit()
                        .then(() => {
                        connection.release();
