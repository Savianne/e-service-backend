...
residentRoute.post('/login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const residentUID = req.body.residentUID;
    if (!residentUID)
        return res.sendStatus(404);
    const poolCon = pool_1.default.promise();
    try {
        const userExist = ((yield poolCon.query(`
        ...
        WHERE r.resident_uid = ?`, [residentUID]))[0][0]);
        if (!userExist)
            return res.sendStatus(404);
        const user = {
...
residentRoute.post('/get-user-info', (req, res) => {
    ...
    if (!userToken)
        return res.sendStatus(404);
    const access_token_secret = process.env.ACCESS_TOKEN_SECRET;
    jsonwebtoken_1.default.verify(userToken, access_token_secret, (error, decoded) => __awaiter(void 0, void 0, void 0, function* () {
        if (error)
            return res.sendStatus(404);
        if (decoded) {
            return res.json({
...
residentRoute.post('/make-request', (req, res) => {
    ...
    poolCon.getConnection()
        ...
        connection.beginTransaction()
            ...
            const insertRequest = (yield connection.query(`
...
residentRoute.post('/get-request-list', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const residentUID = req.body.residentUID;
    if (!residentUID)
        return res.sendStatus(404);
    const poolCon = pool_1.default.promise();
    try {
        const getList = (yield poolCon.query(`
...
residentRoute.delete(`/delete-request/:reqID`, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
residentRoute.delete(`/update-request-status/:reqID/:statusCode`, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const reqID = req.params.reqID;
