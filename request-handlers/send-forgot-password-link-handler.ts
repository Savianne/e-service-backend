...
import { get5MinsExpirationDate } from "../Helpers/get5minsExpDate";

dotenv.config();

const sendForgotPasswordLinkHandler = async (req: Request, res: Response) => {
    ...
    const fpToken = jwt.sign({account: accountInfo, expDate: expirationDate }, access_token_secret, { expiresIn });
...
export default sendForgotPasswordLinkHandler;
