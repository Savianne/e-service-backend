...
async function getSenioCitizenResidentsRecordTransaction() {
    ...
    return new Promise<IQueryPromise>((resolve, reject) => {
        ...
        FROM senior_citizen_members AS scm 
        JOIN residents AS r ON scm.resident_uid = r.resident_uid
...
export default getSenioCitizenResidentsRecordTransaction;
